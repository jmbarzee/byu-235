...
private:
	char maze[5][5][5];
	void setMaze(char maze[5][5][5]);
public:
	vector<string> evaluateNode(Node3D maze[5][5][5], Node3D* crntN, deque<Node3D*>* closedSet);
	Node3D* find(deque<Node3D*> set, Node3D* tofind);
	Pathfinder();
	~Pathfinder() {}
	/*
	 * getMaze
